...
let sound = new Sound(document.querySelector("#sound-div")),
    backgroundSound =  sound.create("./hard01/js-tetris-master/assets/sounds/Tetris_Theme_Cover_LoFi.mp3", "background_sound", true),
    movesSound = sound.create("./hard01/js-tetris-master/assets/sounds/moves.mp3", "moves_sound"),
    dropSound = sound.create("./hard01/js-tetris-master/assets/sounds/drop.mp3", "drop_sound"),
    pointsSound = sound.create("./hard01/js-tetris-master/assets/sounds/points.mp3", "points_sound"),
    finishSound = sound.create("./hard01/js-tetris-master/assets/sounds/finish.mp3", "finish_sound");;
sound.muteToggle();
sound.soundSetting();